...
# Generate plot1 - a histogram of global active power
png("plot1.png", width = 480, height = 480)
hist(newdf$Global_active_power, col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)")
dev.off()

# Generate plot2 - a line graph of global active power 
png("plot2.png", width = 480, height = 480)
plot(newdf$DateTime, as.numeric(as.character(newdf$Global_active_power)), xlab = "", ylab = "Global Active Power (kilowatts)", type = "n")
lines(newdf$DateTime, as.numeric(as.character(newdf$Global_active_power)))
dev.off()

# Generate plot3 - a line graph of Engergy sub metering
png("plot3.png", width = 480, height = 480)
plot(newdf$DateTime, as.numeric(as.character(newdf$Sub_metering_1)), xlab = "", ylab = "Energy sub metering", type = "n")
lines(newdf$DateTime, as.numeric(as.character(newdf$Sub_metering_1)), col = "black")
lines(newdf$DateTime, as.numeric(as.character(newdf$Sub_metering_2)), col = "red")
...
plot(newdf$DateTime, as.numeric(as.character(newdf$Voltage)), xlab = "datetime", ylab = "Voltage", type = "n")
lines(newdf$DateTime, as.numeric(as.character(newdf$Voltage)))
...
plot(newdf$DateTime, as.numeric(as.character(newdf$Global_reactive_power)), xlab = "datetime", ylab = "Global_reactive_power", type = "n")
lines(newdf$DateTime, as.numeric(as.character(newdf$Global_reactive_power)))
dev.off()
